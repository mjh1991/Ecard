<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xfjlmx.aspx.cs" Inherits="xfjlmx" %>
...
<body style="background-color: #F7Feff">
    ...
    <table align="center" width="300">
        ...
        <tr><td align="left" valign="middle">选择食堂：<asp:DropDownList ID="ddlDept" runat="server"  
                                                >
    ...
    <div align="center">
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="lqje" HeaderText="金额" />
