...
init = function(adm) {
	...
	{
		Menus = {
		 "管理员操作": { "row": 1, "show": true, "menu": { "导入补助数据": "bzdr.aspx", "清除补助数据": "bzqc.aspx","导入福利费":"flfdr.aspx"} },
		 "报表查询": { "row": 1, "show": true, "menu": { "餐补发放明细表": "cqffcx.aspx", "餐补消费明细表": "xfjlmx.aspx", "就餐费用汇总表": "xfjlhz.aspx"} },
    ...
    
    {
    	Menus = {
    	    ...
    	    "报表查询": { "row": 1, "show": true, "menu": { "餐补发放明细表": "cqffcx.aspx", "餐补消费明细表": "xfjlmx.aspx", "就餐费用汇总表": "xfjlhz.aspx"} },
    	    "实时监控": { "row": 1, "show": true, "menu": { "消费记录监控": "ssxfmx.aspx"} },
    	    "基本操作": { "row": 1, "show": true, "menu": { "修改密码": "xgmm.aspx"} }
	};
    ...
    {
    Menus = {
        "管理员操作": { "row": 1, "show": true, "menu": { "导入补助数据": "bzdr.aspx", "编辑补助数据": "bzbj.aspx"} },
        "报表查询": { "row": 1, "show": true, "menu": { "餐补发放明细表": "cqffcx.aspx", "餐补消费明细表": "xfjlmx.aspx"} },
        "基本操作": { "row": 1, "show": true, "menu": { "修改密码": "xgmm.aspx"} }
	    };
    }
    else if (adm==4)
    {
        Menus = {
            ...
            "报表查询": { "row": 1, "show": true, "menu": {  "餐补消费明细表": "xfjlmx.aspx", "就餐费用支出汇总表": "gyxfjlhz.aspx"} },
            "基本操作": { "row": 1, "show": true, "menu": { "修改密码": "xgmm.aspx"} }
	    };
    }
