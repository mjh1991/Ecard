<%@ Page Language="C#" AutoEventWireup="true" CodeFile="gyxfjlhz.aspx.cs" Inherits="gyxfjlhz" %>
...
<body style="background-color: #F7Feff">
    ...
    <table align="center" width="400">
        ...
        <tr>
            <td align="left" valign="middle">
                选择食堂：<asp:DropDownList ID="ddlDept" runat="server">
                </asp:DropDownList>
            </td>
        </tr>
    </table>
    ...
    <div align="center">
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
            BorderStyle="Solid" BorderWidth="2px" CaptionAlign="Right" CellPadding="4" ForeColor="#333333"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="xfdd" HeaderText="单   位">
                    <ItemStyle Width="40%" />
                </asp:BoundField>
