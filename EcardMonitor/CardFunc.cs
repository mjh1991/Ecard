...
namespace CardFuncBase
{
	class CardFunc
	{
        ...
        /// <returns></returns>
        [DllImport("project2.dll", CharSet = CharSet.Ansi)]
        private static extern bool newcard1(int port, int kkh, int kh, string xm, string mm, string zxrq, string gn, int zdye, int daymaxje, int xc1, int xc2, int xc3, int xc4, string lx);
