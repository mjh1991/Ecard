<%@ page language="C#" autoeventwireup="true" inherits="mDefault, App_Web_xtkx2qhk" %>



<html>
<head runat="server">
    <title>新乡机务段乘务员餐补系统管理平台</title>
	          ...
	          <tr>
			        ...
			        <td id="main" class="main_border">
				        <div id="main_toolbar" class="toolbarBg">
					        ...
					        <a href="javascript:void(0);" onclick="goTo(this);" rel="showLeft" id="btnShowLeft" class="sh_left_open" title="隐藏左侧导航菜单"><span class="btnIco btnShLeft"></span><span id="manage_title">
				        ...
				        <div id="footer" class="toolbarBg"><span class="left"> 2013 网络中心版权所有.</span></div>
			        </td>
		        </tr>
	        </table>
        </div>
